    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#0a0506] via-[#181111] to-[#0f0909] flex items-center justify-center px-4 relative overflow-hidden">
        ...
        <div className="text-center relative z-10">
          ...
          <p className="text-gray-400 text-lg animate-in fade-in slide-in-from-bottom-3 duration-500 delay-200">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0506] via-[#181111] to-[#0f0909] flex flex-col items-center justify-center px-4 py-8 relative overflow-hidden">
        ...
        <div className="flex items-center gap-3 justify-center mb-4">
          {[1, 2].map((s) => (
            <div key={s} className="relative">
              <div className={`h-2 w-16 rounded-full transition-all duration-500 ${step >= s ? 'bg-gradient-to-r from-[#ea2a33] to-[#c41e3a]' : 'bg-white/10'
                }`} />
              {step >= s && (
      ...
      <div className="w-full max-w-lg relative z-10">
                  ...
                  {STATUS_OPTIONS.map((status) => {
                    ...
                    return (
                      <button
                        ...
                        className={`group relative flex items-center gap-4 p-5 rounded-2xl border transition-all duration-300 ${isSelected
        ...
        <div className={`absolute -bottom-8 left-1/2 -translate-x-1/2 w-3/4 h-24 blur-3xl rounded-full pointer-events-none transition-colors duration-500 ${step === 1 ? 'bg-[#ea2a33]/10' : 'bg-blue-500/10'
          }`}></div>
      </div>
    </div>
  );
