...
const Donation = () => {
  ...
  return (
    <section className="relative py-20 md:py-28 bg-white overflow-hidden" id="donation">
        ...
        <FadeInUp>
          <div className="bg-gradient-to-br from-[#181111] via-[#261c1c] to-[#1a0f0f] rounded-3xl p-10 md:p-16 text-center overflow-hidden relative">
            ...
            <div className="relative">
              ...
              <h2 className={`text-3xl md:text-4xl xl:text-5xl font-black text-white mb-4 leading-tight ${manual?.className || ''}`}>
